...
public class admin_login extends AppCompatActivity {
    ...
    public void SIGN (View view) {
        ...
        if (username.isEmpty() || password.isEmpty()) {
            Toast.makeText(admin_login.this, "Silakan isi username atau kata sandi", Toast.LENGTH_LONG).show();
                    ...
                    if (snapshot.hasChild(username)) {
                        ...
                        if (getPassword.equals(password)) {
                            ...
                            if (getRole.equals("admin")) {
                                Toast.makeText(admin_login.this, "Login berhasil", Toast.LENGTH_LONG).show();

                                Intent intent = new Intent(admin_login.this, Admin_Page.class);
                                startActivity(intent);

                            } else {
                                Toast.makeText(admin_login.this, "Username tidak terdaftar", Toast.LENGTH_LONG).show();

                            }

                        } else {
                            Toast.makeText(admin_login.this, "Kata sandi salah", Toast.LENGTH_LONG).show();
